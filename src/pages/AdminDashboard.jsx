...
import { BarChart3, ShieldAlert, Cpu, Settings, AlertTriangle, Users, CheckCircle, XCircle, Clock } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const { data: menuLogCount } = useQuery({
    queryKey: ["menuLogCount"],
    queryFn: () => base44.entities.MenuDiscoveryLog.list("-created_date", 100),
    initialData: [],
  });
